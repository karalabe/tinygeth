...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	...
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/karalabe/tinygeth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/karalabe/tinygeth/internal/version.gitDate="+env.Date)
	}
