...
coverpkg="github.com/karalabe/tinygeth/..."
...
repo=$GOPATH/src/github.com/karalabe/tinygeth
compile_fuzzer github.com/karalabe/tinygeth/accounts/abi \
  FuzzABI fuzzAbi \
  $repo/accounts/abi/abifuzzer_test.go

compile_fuzzer github.com/karalabe/tinygeth/common/bitutil \
...
compile_fuzzer github.com/karalabe/tinygeth/core/vm/runtime \
  FuzzVmRuntime fuzzVmRuntime\
  $repo/core/vm/runtime/runtime_fuzz_test.go

compile_fuzzer github.com/karalabe/tinygeth/core/vm \
  FuzzPrecompiledContracts fuzzPrecompiledContracts\
  $repo/core/vm/contracts_fuzz_test.go,$repo/core/vm/contracts_test.go

compile_fuzzer github.com/karalabe/tinygeth/core/types \
  FuzzRLP fuzzRlp \
  $repo/core/types/rlp_fuzzer_test.go

compile_fuzzer github.com/karalabe/tinygeth/crypto/blake2b \
  Fuzz fuzzBlake2b \
  $repo/crypto/blake2b/blake2b_f_fuzz_test.go

compile_fuzzer github.com/karalabe/tinygeth/accounts/keystore \
  FuzzPassword fuzzKeystore \
  $repo/accounts/keystore/keystore_fuzzing_test.go

pkg=$repo/trie/
compile_fuzzer github.com/karalabe/tinygeth/trie \
  FuzzTrie fuzzTrie \
...
compile_fuzzer github.com/karalabe/tinygeth/eth/protocols/snap \
...
compile_fuzzer github.com/karalabe/tinygeth/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/karalabe/tinygeth/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
  $repo/tests/fuzzers/txfetcher/txfetcher_test.go

compile_fuzzer github.com/karalabe/tinygeth/tests/fuzzers/bls12381 \
...
compile_fuzzer github.com/karalabe/tinygeth/tests/fuzzers/secp256k1 \
  Fuzz fuzzSecp256k1\
